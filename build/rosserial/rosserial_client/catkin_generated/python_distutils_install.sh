...
echo_and_run cd "/home/john/robot_sanitization/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/john/robot_sanitization/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/john/robot_sanitization/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
