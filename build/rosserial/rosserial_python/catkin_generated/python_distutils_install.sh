...
echo_and_run cd "/home/john/robot_sanitization/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/john/robot_sanitization/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/john/robot_sanitization/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
