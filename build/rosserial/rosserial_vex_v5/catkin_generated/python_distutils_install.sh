...
echo_and_run cd "/home/john/robot_sanitization/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/john/robot_sanitization/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/john/robot_sanitization/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
